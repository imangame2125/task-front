...
const Card: FC<CardProps> = ({ title, description, timePeriods, imageUrl, label1, label2 }) => {
  return (
    <div className='w-72 h-[400px] mx-4 cursor-pointer bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden'>
      <div className='p-4'>
        ...
        <div className='flex space-x-4 mt-2 items-center ml-5'>
        ...
        <div className='flex items-center space-x-2 justify-center mt-9'>
